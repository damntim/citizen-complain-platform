...
$messages = [
    ...
    'body' => "Dear " . $ticket['full_name'] . ",\n\nWe are pleased to inform you that your request (Ticket #" . $ticket['ticket_number'] . ") has been successfully answered by our team.\n\nTo view the response or follow up on your ticket, please visit our website at www.ctm.com and enter your ticket number: " . $ticket['ticket_number'] . "\n\nThank you for reaching out to us.\n\nBest regards,\nCustomer Support Team"
],
'rw' => [
    'subject' => 'Ikibazo Cyanyu #' . $ticket['ticket_number'] . ' Cyasubijwe',
    'body' => "Mukomere " . $ticket['full_name'] . ",\n\nTunejejwe no kubamenyesha ko ikibazo cyanyu (Nomero #" . $ticket['ticket_number'] . ") cyasubijwe neza n'ikipe yacu.\n\nKugira ngo musome igisubizo cyangwa mukurikirane ikibazo cyanyu, musure urubuga rwacu www.ctm.com hanyuma mwinjize nomero y'ikibazo cyanyu: " . $ticket['ticket_number'] . "\n\nTurabashimira ku bw'ubufatanye bwanyu.\n\nMurakoze,\nIkipe Ishinzwe Kwakira Abaturage"
],
'fr' => [
    'subject' => 'Votre Ticket #' . $ticket['ticket_number'] . ' A Reçu Une Réponse',
    'body' => "Cher(e) " . $ticket['full_name'] . ",\n\nNous avons le plaisir de vous informer que votre demande (Ticket #" . $ticket['ticket_number'] . ") a reçu une réponse de la part de notre équipe.\n\nPour consulter la réponse ou faire un suivi, veuillez visiter notre site web à www.ctm.com et saisir votre numéro de ticket: " . $ticket['ticket_number'] . "\n\nMerci de nous avoir contactés.\n\nCordialement,\nL'équipe du Support Client"
]
];
